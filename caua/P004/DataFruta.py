...
class ListaNomes(AnaliseDados):
    ...
    def listarEmOrdem(self):
        ...
        lista_ordenada = self.__lista.copy()
        lista_ordenada.sort()
...
class ListaDatas(AnaliseDados):
    ...
    def modificarDatasAnteriores(self):
        if len(self.__lista) == 0:
            print("Lista de datas vazia.")
            return
        
        print("----------Modificando datas antes de 2019----------")
        listaFiltrada = filter(filterData, self.__lista)
...
class ListaSalarios(AnaliseDados):
    ...
    def listarEmOrdem(self):
        ...
        print("----------Lista de salarios em ordem----------")
        lista_ordenada = self.__lista.copy()
        lista_ordenada.sort()
        for i in lista_ordenada:
            print(i)

    def calcularReajuste(self):
        if len(self.__lista) == 0:
                print("Lista de salarios vazia.")
                return
        
        print("----------Folha de pagamento pos reajuste----------")
        listaMap = map(aumentaDezPorCento, self.__lista)
        for i in listaMap:
            print(f'R${i:.2f}')
...
def aumentaDezPorCento(salario):
    return salario * 1.1
...
def main():
    ...
    print("----------Listando nomes e Salarios----------")
    listaZip = zip(nomes.getLista(), salarios.getLista())
    for i1, i2 in listaZip:
        print(i1, "-", i2)

    salarios.calcularReajuste()
    datas.modificarDatasAnteriores()
